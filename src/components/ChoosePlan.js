  ...
  return (
    <div>
      <div className="p-[1px] planBorder mx-20 rounded-2xl">
        <div className="rounded-2xl bg-[#191919] md:grid gap-8 p-16 font-axiforma hidden">
          <div className=" grid grid-cols-4 justify-items-center">
            <div></div>
            <div className="text-sm font-medium text-[#4F5665]">
              3-day trial
            </div>
            <div className="text-sm font-medium text-[#4F5665]">
          ...
          <div className=" grid grid-cols-4 justify-items-center">
            <div className="text-sm text-left">Unlimited Bandwidth</div>
          ...
          <div className=" grid grid-cols-4 justify-items-center">
            <div className="text-sm text-left">Encrypted Connection</div>
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
          </div>
          ...
          <div className=" grid grid-cols-4 justify-items-center">
            <div className="text-sm text-left">Traffic Logs</div>
          ...
          <div className=" grid grid-cols-4 justify-items-center">
            <div className="text-sm text-left">Works on all Devices</div>
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
          </div>
          ...
          <div className=" grid grid-cols-4 justify-items-center">
            <div className="text-sm text-left">Connect Anywhere</div>
            <IoMdClose className="p-2 text-3xl text-white rounded-full border-2 border-[#EB1818]" />
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
          </div>
          ...
          <div className=" grid grid-cols-4 justify-items-center">
            <div className="text-sm text-left">Access to all Features</div>
            <IoMdClose className="p-2 text-3xl text-white rounded-full border-2 border-[#EB1818]" />
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
            <AiOutlineCheck className="p-2 text-3xl text-white rounded-full border-2 border-[#5D18EB]" />
          </div>
      ...
      <div className="grid gap-6">
        <div className="p-[1px] planBorder  rounded-xl md:hidden">
          <div className="md:mx-12 rounded-xl bg-[#191919] grid font-axiforma p-10 text-center ">
            <div className="text-sm font-medium text-[#4F5665]">
              3-day trial
            </div>
        ...
        <div className="p-[1px] planBorder  rounded-xl md:hidden">
          <div className="md:mx-12 rounded-xl bg-[#191919] grid font-axiforma p-10 text-center ">
            ...
            <div className="text-3xl font-medium mt-6 mb-10">$4.99</div>
            <div className="grid gap-6 w-full">
              <div className="flex items-center justify-between">
                <div className="text-sm text-left">Unlimited Bandwidth</div>
                <div className="p-2 text-3s text-white rounded-full border-2 border-[#5D18EB]">
        ...
        <div className="p-[1px] planBorder  rounded-xl md:hidden">
          <div className="md:mx-12 rounded-xl bg-[#191919] grid font-axiforma p-10 text-center ">
            ...
            <div className="text-3xl font-medium mt-6 mb-10">$39.99</div>
            <div className="grid gap-6 w-full">
              <div className="flex items-center justify-between">
                <div className="text-sm text-left">Unlimited Bandwidth</div>
                <div className="p-2 text-3s text-white rounded-full border-2 border-[#5D18EB]">
